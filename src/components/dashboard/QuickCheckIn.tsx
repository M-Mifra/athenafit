...
const QuickCheckIn = ({ onResult }: QuickCheckInProps) => {
  ...
  return (
    <div className="bg-gradient-to-br from-background via-background/80 to-primary/10 rounded-3xl p-8 pb-16 animate-fade-up border border-white/20 shadow-[0_0_80px_-15px_rgba(var(--primary),0.2)] backdrop-blur-3xl relative max-h-[90vh] overflow-y-auto custom-scrollbar">
